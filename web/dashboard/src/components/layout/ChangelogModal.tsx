  ...
  const changes = [
    {
      ...
      items: [
        ...
        { icon: <ShieldCheck className="text-emerald-500" size={14} />, title: 'ExtraHosts Injection', description: 'Automatic host.docker.internal:host-gateway mapping for all platforms.' }
      ]
    },
    {
